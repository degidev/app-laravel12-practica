...
<body>
    <section class="flex flex-col justify-center items-center h-screen mx-auto min-h-dvh
        ...
        <div class="flex flex-wrap justify-center gap-6 mt-8">
            <!-- GitHub -->
            <a href="https://github.com/lipadev" target="_blank"  aria-label="GitHub" title="Ir a GitHub"
        ...
        <p class="text-white text-center mt-4">
            🐧 Diego Lipa <a href="https://github.com/lipadev" target="_blank" class="text-blue-500 hover:underline">@lipadev</a>
        </p>
        <p class="text-white text-center mt-4">
            &copy; {{ date('Y') }} Hola Mundo. Todos los derechos reservados.
        </p>
    </section>
</body>
</html>